...
//		FirefoxDriver driver = (FirefoxDriver) WebTesting.launchDriver("https://www.google.com", "firefox");
		...
		try {
			cancelButton = driver.findElement(By.xpath("//g-raised-button[@jsaction='dArJMd']")).isDisplayed());
		} catch (NoSuchElementException ex) {
			fail("\"CANCEL\" button not found.");
		}
...
//		ChromeDriver driver = (ChromeDriver) WebTesting.launchDriver("https://www.google.com", "chrome");
		...
		// HINT: the search bar has attribute name="q"
		try {
			shortWait.until(ExpectedCondition.visibilityOfElementLocated(By.name("q")));
		} catch (TimeoutException ex) {
			fail("Search bar not found.");
		}
...
//		ChromeDriver driver = (ChromeDriver) WebTesting.launchDriver("https://www.google.com", "chrome");
		...
		// HINT: a relevant div has class="tyYmIf"
		try {
			driver.findElement(By.xpath("//div[@class='tyYmIf']"));
		} catch (NoSuchElementException ex) {
			fail("Calculator not found.");
		}
		...
		// HINT: the "1" button is a div with jsname="N10B9"
		driver.findElement(By.xpath("//div[@jsname='N10B9']")).sendKeys("1").click();
		...
		try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'8\']")); 
		} catch (NoSuchElementException ex) { fail("\"8\" was not input."); }
		
		driver.findElement(By.cssSelector("div[jsname=\'rk7bOd\']")).click(); 
		try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87\']")); 
		} catch (NoSuchElementException ex) { fail("\"7\" was not input."); } 
		driver.findElement(By.cssSelector("div[jsname=\'XSr6wc\']")).click(); 
		try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87 + \']")); } 
		catch (NoSuchElementException ex) { fail("\"+\" was not input."); } 
		driver.findElement(By.cssSelector("div[jsname=\'Ax5wH\']")).click(); 
		try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87 + 5\']")); } 
		catch (NoSuchElementException ex) { fail("\"5\" was not input."); } driver.findElement(By.cssSelector("div[jsname=\'lVjWed\']")).click(); try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'87 + 52\']")); } catch (NoSuchElementException ex) { fail("\"2\" was not input."); } driver.findElement(By.cssSelector("div[jsname=\'Pt8tGc\']")).click(); try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'139\']")); } catch (NoSuchElementException ex) { fail("\"139\" was not the solution."); } driver.findElement(By.cssSelector("div[jsname=\'SLn8gc\']")).click(); try { driver.findElement(By.xpath("//span[@id=\'cwos\' and text()=\'0\']")); } catch (NoSuchElementException ex) { fail("Output not cleared to \"0\"."); } try { TimeUnit.SECONDS.sleep(5); } catch (InterruptedException e) { // TODO Auto-generated catch block e.printStackTrace(); }
		}
